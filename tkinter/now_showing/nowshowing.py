...
class movies:
    def __init__(self):
        movie1 = nowshowing("Bell Bottom", 300, 450, "bellbottomposter.png", 0, 0)
        movie2 = nowshowing("Free guy", 300, 450, "freeguyposter.png", 0, 1)
        movie3 = nowshowing("Pierrot-Le-Fou", 300, 450, "pierrotposter.png", 0, 2)
        movie4 = nowshowing("Fast and Furious 9", 317, 450, "f9poster.png", 0, 3)
        movie5 = nowshowing("Shang-Chi", 300, 450, "shangposter.png", 0, 4)
